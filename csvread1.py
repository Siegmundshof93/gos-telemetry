...
with PdfPages(r'C:\Users\Hugo Tamini\Desktop\Pavel\gos-telemetry\plots.pdf') as pdf:
...
exec(open(r'C:\Users\Hugo Tamini\Desktop\Pavel\gos-telemetry\description1.py').read())

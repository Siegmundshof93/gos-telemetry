...
pdf.output(r'C:\Users\Hugo Tamini\Desktop\Pavel\gos-telemetry\beschreibung.pdf')


exec(open(r'C:\Users\Hugo Tamini\Desktop\Pavel\gos-telemetry\merger1.py').read())
